      ...
      <div class="h-[75vh] bg-gradient-to-r from-energy-800/80 to-top-500/50">
          <div class="flex h-full justify-center items-center place-content-center">
                 <div class="text-white text-center space-y-5">
                     <h1 class="text-6xl font-bold text-top-500">{{ __('home.powering_your') }} <span class="text-energy-800">{{ __('home.energy_future') }}</span></h1>
                     <p class="text-xl">{{ __('home.trusted_partner') }}</p>
                     <div class="flex justify-center">
                         <a href="{{route('orders.index')}}">
                             <button class="btn-secondary flex gap-2 items-center" data-aos="flip-up">
                                 <span>{{ __('home.order_now') }}</span>
    ...
    <section>
        <div class="max-w-5xl mx-auto py-14 space-y-5">
            <div class="text-center">
                <h2 class="text-3xl font-bold text-top-500">{{ __('home.energy_solutions') }}</h2>
                <p>{{ __('home.comprehensive_services') }}</p>
            </div>
            <div class="grid md:grid-cols-3 gap-5 container">
                <div class="bg-slate-100 p-5 space-y-2 hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-top-500/30 rounded-lg " data-aos="fade-right">
                    <div class="flex justify-center">
                    ...
                    <div class="text-center">
                        <h3 class="text-xl font-bold text-top-500">{{ __('home.import') }}</h3>
                        <p>{{ __('home.import_desc') }}</p>
                    </div>
                </div>
                <div class="bg-slate-100 p-5 space-y-2 hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-top-500/30 rounded-lg" data-aos="zoom-in">
                    <div class="flex justify-center">
                        <div class="h-12 w-12 rounded-full flex place-content-center bg-linear-to-r/srgb from-energy-800 to-top-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 text-white self-center" viewBox="0 0 24 24">
                    ...
                    <div class="text-center">
                        <h3 class="text-xl font-bold text-top-500">{{ __('home.sales_marketing') }}</h3>
                        <p>{{ __('home.sales_marketing_desc') }}</p>
                    </div>
                </div>
                <div class="bg-slate-100 p-5 space-y-2 hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-top-500/30 rounded-lg" data-aos="fade-left">
                    <div class="flex justify-center">
                        <div class="h-12 w-12 rounded-full flex place-content-center bg-linear-to-r/srgb from-energy-800 to-top-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 text-white self-center" viewBox="0 0 24 24">
                    ...
                    <div class="text-center">
                        <h3 class="text-xl font-bold text-top-500">{{ __('home.distribution') }}</h3>
                        <p>{{ __('home.distribution_desc') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-slate-100">
        <div class="max-w-5xl mx-auto py-14">
            <div class="text-center space-y-3">
                <h2 class="text-3xl font-bold text-top-500">{{ __('home.welcome') }}</h2>
                <p>{{ __('home.contact_us') }} {{ __('home.comprehensive_services') }}</p>
                <div class="flex justify-center">
                    <a href="{{route('orders.index')}}">
